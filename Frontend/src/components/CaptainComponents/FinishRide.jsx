...
export const FinishRide = ({ setIsPanelOpen, rideData }) => {
    ...
    const rideCompleteFunction = async () => {
        try {
            const response = await axios.post(`${import.meta.env.VITE_API_URL}/rides/endRide`,
                { rideId: rideData._id },
            ...
            <div className='w-full flex justify-center items-center flex-col'>
                <div className='w-[70%]'>
                    ...
                    <div className='flex flex-col justify-center items-center py-6 gap-2'>
                        ...
                        <button onClick={rideCompleteFunction} className='bg-green-700 text-white text-center text-xl font-bold px-10 mt-6 py-3 rounded-xl cursor-pointer hover:bg-green-600'>Finish Ride</button>
                    </div>
                </div>
