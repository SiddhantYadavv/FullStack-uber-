    ...
    return (
        <>
            <div className='w-[40%] flex flex-col items-center justify-center'>
                ...
                <button onClick={() => handlePress()} className='bg-green-700 px-10 py-3 rounded-2xl text-white font-bold cursor-pointer hover:bg-green-600'>{isWaiting ? "Cancel" : "Confirm Booking"}</button>
